...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-[url('/bg-wood.webp')] bg-[#2a160c]/80 bg-blend-multiply bg-cover bg-center border-b-4 border-gold/30 p-6 flex items-center justify-between">
      <Link href="/">
        <Image
          src="/logo.webp"
      ...
      <ul className="hidden md:flex items-center gap-8 text-gold font-medium">
        ...
        <li className="relative group">
          ...
          {/* Invisible wrapper with pt-2 creates a hover bridge */}
