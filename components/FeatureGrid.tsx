export default function FeatureGrid() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8 max-w-7xl mx-auto -mt-24 relative z-20">
      ...
      {/* Card 1: About Us */}
      <div className="bg-wood-medium border rounded-sm border-gold/40 p-10 text-center hover:border-gold transition-all duration-500 hover:shadow-teal hover:-translate-y-2">
        ...
        <button className="text-gold border rounded-sm border-gold/50 px-6 py-2 hover:bg-gold hover:text-wood-dark transition-all">Learn More</button>
      </div>
      ...
      <div className="bg-wood-medium border rounded-sm border-gold/40 p-10 text-center hover:border-gold transition-all duration-500 hover:shadow-teal hover:-translate-y-2">
        ...
        <button className="text-gold border rounded-sm border-gold/50 px-6 py-2 hover:bg-gold hover:text-wood-dark transition-all">Find a Vendor</button>
      </div>
